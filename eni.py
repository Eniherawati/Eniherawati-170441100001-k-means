...
def program():
    dataset = pd.read_csv("jumlah-rumah-tangga-miskin-mengkonsumsi-air-minum-menurut-kecamatan-2017.csv")

    # mengambil kolom 3 dan 5
    kol_mandiri = dataset.iloc[:, 3].values
    kol_jumlah = dataset.iloc[:, 4].values
